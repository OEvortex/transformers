# coding=utf-8
# Copyright 2025 HelpingAI and the HuggingFace Inc. team. All rights reserved.
#
...
class HelpingaiConfig(LlamaConfig):
    r"""
    This is the configuration class to store the configuration of a [`HelpingaiModel`]. It is used to instantiate a HelpingAI
    model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
    defaults will yield a similar configuration to that of the HelpingAI hai3.1.

    Pre-trained weights are available at
    [HelpingAI/hai3.1-checkpoint-0002](https://huggingface.co/HelpingAI/hai3.1-checkpoint-0002)
    ...
    >>> # Initializing a HelpingAI style configuration
    >>> configuration = HelpingaiConfig()

    >>> # Initializing a model from the HelpingAI style configuration
...
@auto_docstring(checkpoint="HelpingAI/hai3.1-checkpoint-0002")
class HelpingaiForCausalLM(LlamaForCausalLM):
    pass


@auto_docstring(checkpoint="HelpingAI/hai3.1-checkpoint-0002")
class HelpingaiForSequenceClassification(LlamaForSequenceClassification):
    pass


@auto_docstring(checkpoint="HelpingAI/hai3.1-checkpoint-0002")
class HelpingaiForQuestionAnswering(LlamaForQuestionAnswering):
    pass


@auto_docstring(checkpoint="HelpingAI/hai3.1-checkpoint-0002")
class HelpingaiForTokenClassification(LlamaForTokenClassification):
    pass
